...
#define STRING_CONFIG_H_AUTHOR "Zaribo Piff" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //
#define DEFAULT_Kp 40.10
#define DEFAULT_Ki 4.33
#define DEFAULT_Kd 92.81
  // MakerGear
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 318.68
  #define DEFAULT_bedKi 61.75
  #define DEFAULT_bedKd 411.17
